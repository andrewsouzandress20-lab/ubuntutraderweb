...
const PROXIES = [
  'https://ubuntutraderweb-backend.vercel.app/api/tradingview?url=', // Altere para sua URL Vercel real
  'https://api.allorigins.win/get?url=',
  'https://corsproxy.io/?',
  'https://thingproxy.freeboard.io/fetch/',
  'http://localhost:4000/api/tradingview?url=', // Local por último, apenas para desenvolvimento
];
